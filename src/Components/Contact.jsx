...
const Contact = () => {
  ...
  const scriptURL =
    "https://script.google.com/macros/s/AKfycbz-1KdCncz6PTP-pbqekWLSb-NjJR_7lCLb9nruAV1kNCK_y2oPnpkSwfV0CV99k6yI0A/exec";
  ...
  const contact_info = [
    { logo: "mail", text: "pradhiveragul@gmail.com" },
    { logo: "logo-whatsapp", text: "+91 97881 62003" },
  ];
  return (
    <section
      id="contact"
                ...
                <div
                  ...
                  onClick={() => {
                    if (contact.logo == "logo-whatsapp") {
                      const urlToOpen =
                        "https://api.whatsapp.com/send/?phone=9788162003&text&type=phone_number&app_absent=0";
                      window.open(urlToOpen, "_blank");
                    } else {
                      window.location.href =
                        "mailto:pradhiveragul@gmail.com?subject=Welcome&body=Glad to Contact you";
                    }
                  }}
                >
